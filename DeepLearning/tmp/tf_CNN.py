...
mnist = mnist.read_data_sets("./mnist/data/", one_hot=True)
...
class Model():
    ...
    def train(self, n_epochs=15, batch_size=100):
        total_batch = self.data.train.num_examples // batch_size
